...
import (
	...
	"github.com/onmetal/onmetal-api-net/client-go/onmetalapinet/scheme"
...
type CoreV1alpha1Interface interface {
	...
	NetworkPolicyTargetsesGetter
	NodesGetter
}

// CoreV1alpha1Client is used to interact with features provided by the core.apinet.api.onmetal.de group.
...
func (c *CoreV1alpha1Client) NetworkPolicyTargetses(namespace string) NetworkPolicyTargetsInterface {
	return newNetworkPolicyTargetses(c, namespace)
}
