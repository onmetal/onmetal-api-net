...
func (c *FakeNetworkPolicies) Apply(ctx context.Context, networkPolicy *corev1alpha1.NetworkPolicyApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.NetworkPolicy, err error) {
...
func (c *FakeNetworkPolicies) ApplyStatus(ctx context.Context, networkPolicy *corev1alpha1.NetworkPolicyApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.NetworkPolicy, err error) {
	if networkPolicy == nil {
		return nil, fmt.Errorf("networkPolicy provided to Apply must not be nil")
	}
	data, err := json.Marshal(networkPolicy)
