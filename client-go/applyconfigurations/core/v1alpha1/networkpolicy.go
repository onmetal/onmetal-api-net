...
func extractNetworkPolicy(networkPolicy *corev1alpha1.NetworkPolicy, fieldManager string, subresource string) (*NetworkPolicyApplyConfiguration, error) {
	b := &NetworkPolicyApplyConfiguration{}
	err := managedfields.ExtractInto(networkPolicy, internal.Parser().Type("com.github.onmetal.onmetal-api-net.api.core.v1alpha1.NetworkPolicy"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
