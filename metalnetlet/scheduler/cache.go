...
type CacheStrategy interface {
	Key(instance *v1alpha1.LoadBalancerInstance) (types.UID, error)
	ContainerKey(instance *v1alpha1.LoadBalancerInstance) string
}
...
func (defaultCacheStrategy) Key(instance *v1alpha1.LoadBalancerInstance) (types.UID, error) {
	uid := instance.GetUID()
	if uid == "" {
...
func (defaultCacheStrategy) ContainerKey(instance *v1alpha1.LoadBalancerInstance) string {
	return instance.Spec.NodeRef.Name
}
...
func (c *Cache) IsAssumedInstance(instance *v1alpha1.LoadBalancerInstance) (bool, error) {
...
func (c *Cache) AssumeInstance(instance *v1alpha1.LoadBalancerInstance) error {
	log := c.log.WithValues("Instance", klog.KObj(instance))
	key, err := c.strategy.Key(instance)
	if err != nil {
		return err
...
func (c *Cache) ForgetInstance(instance *v1alpha1.LoadBalancerInstance) error {
	log := c.log.WithValues("Instance", klog.KObj(instance))
	key, err := c.strategy.Key(instance)
	if err != nil {
		return err
...
func (c *Cache) FinishBinding(instance *v1alpha1.LoadBalancerInstance) error {
	log := c.log.WithValues("Instance", klog.KObj(instance))
	key, err := c.strategy.Key(instance)
	if err != nil {
		return err
...
func (c *Cache) AddInstance(instance *v1alpha1.LoadBalancerInstance) error {
	log := c.log.WithValues("Instance", klog.KObj(instance))
	key, err := c.strategy.Key(instance)
	if err != nil {
		return err
...
func (c *Cache) UpdateInstance(oldInstance, newInstance *v1alpha1.LoadBalancerInstance) error {
...
func (c *Cache) RemoveInstance(instance *v1alpha1.LoadBalancerInstance) error {
	log := c.log.WithValues("Instance", klog.KObj(instance))
	key, err := c.strategy.Key(instance)
	if err != nil {
		return err
...
func (c *Cache) updateInstance(log logr.Logger, key types.UID, oldInstance, newInstance *v1alpha1.LoadBalancerInstance) {
	c.removeInstance(log, key, oldInstance)
	c.addInstance(log, key, newInstance, false)
}

func (c *Cache) addInstance(_ logr.Logger, key types.UID, instance *v1alpha1.LoadBalancerInstance, assume bool) {
...
func (c *Cache) removeInstance(log logr.Logger, key types.UID, instance *v1alpha1.LoadBalancerInstance) {
	containerKey := c.strategy.ContainerKey(instance)
	n, ok := c.nodes[containerKey]
	if !ok {
